...
export interface StargatePoolUSDCInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'addTreasuryFee'
      | 'allowBurn'
...
export namespace Path_CreditBurnedEvent {
...
export interface StargatePoolUSDC extends BaseContract {
  connect(runner?: ContractRunner | null): StargatePoolUSDC;
  ...
  allowBurn: TypedContractMethod<
    [_burnAdmin: AddressLike, _burnAllowanceSD: BigNumberish],
    [void],
    'nonpayable'
  >;
  ...
  burnAdmin: TypedContractMethod<[], [string], 'view'>;

  burnAllowanceSD: TypedContractMethod<[], [bigint], 'view'>;

  burnLockedUSDC: TypedContractMethod<[], [void], 'nonpayable'>;
  ...
  getFunction(
    nameOrSignature: 'burnAdmin',
  ): TypedContractMethod<[], [string], 'view'>;
  getFunction(
    nameOrSignature: 'burnAllowanceSD',
  ): TypedContractMethod<[], [bigint], 'view'>;
  getFunction(
    nameOrSignature: 'burnLockedUSDC',
  ...
  getFunction(
    ...
    'nonpayable'
  >;
  getFunction(nameOrSignature: 'redeemSend'): TypedContractMethod<
    [
      _sendParam: SendParamStruct,
      _fee: MessagingFeeStruct,
      _refundAddress: AddressLike,
  ...
  >;
  getEvent(
    key: 'Path_CreditBurned',
  ): TypedContractEvent<
    Path_CreditBurnedEvent.InputTuple,
    Path_CreditBurnedEvent.OutputTuple,
    Path_CreditBurnedEvent.OutputObject
  >;
  getEvent(
    key: 'PauseSet',
  ): TypedContractEvent<
  ...
  filters: {
    ...
    'Path_CreditBurned(uint64)': TypedContractEvent<
      Path_CreditBurnedEvent.InputTuple,
      Path_CreditBurnedEvent.OutputTuple,
      Path_CreditBurnedEvent.OutputObject
    >;
    Path_CreditBurned: TypedContractEvent<
      Path_CreditBurnedEvent.InputTuple,
      Path_CreditBurnedEvent.OutputTuple,
      Path_CreditBurnedEvent.OutputObject
    >;
