...
import type {
  ...
  ExchangeLayerZeroAdapterInterface,
} from '../ExchangeLayerZeroAdapter';
...
export class ExchangeLayerZeroAdapter__factory {
  static readonly abi = _abi;
  static createInterface(): ExchangeLayerZeroAdapterInterface {
    return new Interface(_abi) as ExchangeLayerZeroAdapterInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner,
    ) as unknown as ExchangeLayerZeroAdapter;
  }
}
